...
class CacheService:
    """Azure Redis cache with automatic fallback if unavailable."""
    ...
    def __init__(self):
        ...
        try:
            # Azure Cache for Redis requires SSL
            ...
            elif settings.redis_hostname and settings.redis_password:
                # Use hostname/password with SSL
            ...
            self.enabled = True
            print(f"✓ Azure Redis cache connected")
